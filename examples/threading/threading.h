...
struct thread_data{
    ...
    /*This mutex is coupled with the data it is intended to protect*/
    ...
    /*This portion of the struct holds the wait times for obtain and release*/	
    int obtain_time_ms, release_time_ms;
